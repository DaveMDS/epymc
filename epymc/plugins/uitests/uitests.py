...
class MyItemClass(EmcItemClass):
    ...
    def item_selected(self, url, user_data):
        ...
        # Dialog - Panel full more
            ...
            d.button_add('One', selected_cb=lambda _: print('btn1 callback'))
            d.button_add('Two', selected_cb=lambda _: print('btn2 callback'))
            d.button_add('Tree', selected_cb=lambda _: print('btn3 callback'))
        ...
        # Buttons Theme + Focus
            ...
            hbox2.horizontal_set(True)
            hbox2.show()
            icons = ['icon/prev', 'icon/fbwd', 'icon/bwd', 'icon/stop', 'icon/play', 'icon/fwd', 'icon/ffwd',
                     'icon/next']
            for i in icons:
...
class UiTestsModule(EmcModule):
    ...
    @staticmethod
    def populate_encoding_page(browser, url):
    ...
    @staticmethod
    def populate_image_page(browser, url):
    ...
    @staticmethod
    def populate_views_page(browser, url):
